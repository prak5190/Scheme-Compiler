...
a1_public:
	git checkout a1 ; git merge --no-edit common ; git push origin a1

a2_public:
	git checkout a2 ; git merge --no-edit common ; git push origin a2
...
a1_private:
	git checkout a1 ; git pull --no-edit framework a1 ; git push origin a1

a2_private:
	git checkout a2 ; git pull --no-edit framework a2 ; git push origin a2
