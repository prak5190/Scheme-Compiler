                                         ...
                                         (let* ((u1 (get-unique-name (append ls tls)))
                                           ...
                                           (enforce* enforce-mc-s2  
                                                   `(begin
                                                      (set! ,u1 ,y)
                                                      (set! ,u2 ,z)
                                                      (,x ,u1 ,u2))(cons u2 (cons u1 ls)) tls)))
                                        (else (values ls `(,exp)))))
