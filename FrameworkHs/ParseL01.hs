...
import FrameworkHs.Helpers (parseListWithFinal, parseInt32, parseInt64, parseBinop, parseReg, parseFailureM, PassM)
...
parseStatement e = parseFailureM ("Invalid Statement: " ++ show e)
